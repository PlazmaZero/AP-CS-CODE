...
public class FreightTrain
{
    ...
    {
      Boxcar car1 = new Boxcar("gizmos", 5, false);
      if (n<=0)
      {
     train.add(car1);
      }
    ...
    public void setMultiCargo()
    {
      ...
      { Boxcar pcar1= new Boxcar();
        Boxcar pcar2= new Boxcar();
        Boxcar pcar3= new Boxcar();
        Boxcar pcar4= new Boxcar();
        pcar1=train.get(i);
        pcar2=train.get(i+1);
        pcar3=train.get(i+2);
        pcar4=train.get(i+3);
        pcar1.setCargo("gizmos");
        pcar2.setCargo("gadgets");
        pcar3.setCargo("widgets");
        pcar4.setCargo("wadgets");
        train.set(i,pcar1);
        train.set(i+1,pcar2);
        train.set(i+2,pcar3);
        train.set(i+3,pcar4);
    ...
    { Boxcar carcopy= new Boxcar();
      carcopy=train.get(i);
      carcopy.callForRepair();
      train.set(i,carcopy);
